            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3 pt-2">
                <button
                  ...
                  className="px-4 py-2 bg-[var(--accent-color)] text-white rounded-md text-sm font-medium hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-opacity"
                >
