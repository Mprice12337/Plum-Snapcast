...
const ControlButton: React.FC<{ onClick?: () => void; icon: string; size?: 'sm' | 'md' | 'lg' }> = ({ onClick, icon, size = 'md' }) => {
  const sizeClasses = {
...
export const PlayerControls: React.FC<PlayerControlsProps> = ({ stream, volume, onVolumeChange, onPlayPause, onSkip }) => {
