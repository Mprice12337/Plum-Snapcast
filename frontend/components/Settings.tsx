...
import type { Settings as SettingsType, ThemeMode, AccentColor } from '../types';
      ...
      >
        ...
        <div className="p-6 space-y-8 max-h-[70vh] overflow-y-auto">
            <Section title="Integrations">
                <Switch label="AirPlay Enabled" checked={settings.integrations.airplay} onChange={(val) => handleIntegrationChange('airplay', val)} />
                <Switch label="Spotify Connect Enabled" checked={settings.integrations.spotifyConnect} onChange={(val) => handleIntegrationChange('spotifyConnect', val)} />
                <Switch label="Snapcast Stream Enabled" checked={settings.integrations.snapcast} onChange={(val) => handleIntegrationChange('snapcast', val)} />
            </Section>

            <Section title="Appearance">
                 <Switch label="Visualizer Enabled" checked={settings.integrations.visualizer} onChange={(val) => handleIntegrationChange('visualizer', val)} />
                <div>
